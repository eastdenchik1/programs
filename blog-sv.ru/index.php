      ...
      <div class="container">
        <div class="row">
          <section class="content__left col-md-8">
                    ...
                    <div class="article__info">
                      ...
                      <div class="article__info__meta">
                        ...
                        foreach($categories as $cat) {
                          ...
                          ?>
                        <small>Категория: <a href="/categories.php?cat=<?php echo $art_cat['id']; ?>"><?php echo $art_cat['title']; ?></a></small>
                      </div>
            ...
            <div class="block">
              <a href="/categories.php?cat=6">Все записи</a>
            ...
            <div class="block">
              <a href="/categories.php?cat=3">Все записи</a>
